...
<body>
	...
	<div class="container">
<a href="https://lexacademy.in" target="_blank"><img src="upload_images/logo.jpg" alt="" width="100px" ></a><br><hr>
...
?>
  ...
  <i class="fa fa-plus"></i> Student Fill Up
  </button>
  <a href="export.php" class="hidden"><i class="fa fa-download"></i> Export Data</a>
  <hr>
     ...
     <input type="submit" name="export" class="hidden" value="Export Data" />
    </form>
	</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="upload_images/logo.jpg" width="100px" height="80px" alt=""></center>
...
<input type="text" class="form-control" name="card_no" placeholder="Enter 5-digit Student Id." maxlength="5" required>
</div>
<div class="form-group col-md-6">
...
<input type="text" class="form-control" name="user_aadhar" maxlength="11" placeholder="Enter 11-digit Aadhar no. ">
</div>
</div>
...
<input type="text" class="form-control" name="staff_id" maxlength="6" placeholder="Enter 6-digit Staff Id">
</div>
